...
func (tr *User) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"auth_string_hashed": "authStringHashedSecretRef", "password": "passwordSecretRef", "plaintext_password": "plaintextPasswordSecretRef"}
}
...
func (tr *User) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("AuthPlugin"))
	opts = append(opts, resource.WithNameFilter("Password"))
	opts = append(opts, resource.WithNameFilter("PlaintextPassword"))
